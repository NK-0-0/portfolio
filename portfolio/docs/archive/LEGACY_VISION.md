> **ARCHIVED — superseded 2026-07-04.** This describes the original hover/hotspot-on-Kakashi concept, which was abandoned mid-build (see `docs/ROADMAP.md` Finding 2–3) in favor of the scroll-driven architecture, and used Naruto-franchise fan-IP assets that are being removed entirely. Kept for historical record only — do not implement anything from this file. Current vision: `docs/vision/VISION.md`.
